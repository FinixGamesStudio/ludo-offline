...
namespace Ludo
{
    public class LudoInternetController : MonoBehaviour
    {
        ...
        private void SendPing()
        {
            ...
            gameManager.socketConnection.SendDataToSocket(gameManager.socketEventManager.RequestHeartBeat(), HeartBeatAcknowledgement, LudoNumberEventList.HEART_BEAT.ToString());
        }
