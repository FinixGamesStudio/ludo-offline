    ...
    public class LudoTimerController : MonoBehaviour
    {
        ...
        public void GameMainTimer()
        {
            ...
            if (gameMainTimer.data.waitingTimer <= 0)
            {
                ...
                if (LudoGameManager.instace.gamePlayMode == GamePlayMode.Offline)
                    LudoGameManager.instace.aiController.BattleFinish();
            }
        }
        ...
        IEnumerator Time()
        {
            ...
            if (waitingTimer == 0)
            {
                ...
                if (LudoGameManager.instace.gamePlayMode == GamePlayMode.Offline)
                {
                    if (LudoGameManager.instace.signUpRequestSDKData.gameModeName.Equals("DICE"))
                        LudoGameManager.instace.aiController.MainTimerAi();

                    LudoGameManager.instace.aiController.AiUserTurn();
                }
            }
        }
